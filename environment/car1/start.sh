...
node aws-iot-device-sdk-js-v2/samples/node/pub_sub/dist/index.js --endpoint axu02zw5z9hjp-ats.iot.us-east-1.amazonaws.com --key car1.private.key --cert car1.cert.pem --ca_file root-CA.crt --client_id sdk-nodejs-v2 --topic topic_1